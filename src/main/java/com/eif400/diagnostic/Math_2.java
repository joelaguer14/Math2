...
public class Math_2 {
    ...
    public static void main(String[] args){
        ...
        for (int n =10; n < 25; n++){
            ...
            Double tiempoFP= Double.valueOf((tiempoFPFinal*1000-tiempoFPInicio*1000));
            ...
            Double tiempoFPConcurrente= Double.valueOf((tiempoFPConcurrenteFinal*1000-tiempoFPConcurrenteInicio*1000));
            System.out.format(
                    "n=%2d Math.E=%1.16f, E_FP=%1.16f Tiempo: %f  E_FPConcurrente=%1.16f Tiempo: %f  %n",
                    n,
                    E,
